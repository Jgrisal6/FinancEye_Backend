...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference("Currency.count") do
      post currencies_url, params: { currency: { currency_name: @currency.currency_name, description: @currency.description } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { currency_name: @currency.currency_name, description: @currency.description } }
